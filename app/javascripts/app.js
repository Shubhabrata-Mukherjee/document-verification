...
import fileRecord_artifact from '../../build/contracts/Records.json'

// MetaCoin is our usable abstraction, which we'll use through the code below.
var   Record = contract(fileRecord_artifact);
...
window.App = {
  ...
  checkTransaction: function() {
     var _fileHash1 = document.getElementById("fileDisplayArea2").value;    

    Record.deployed().then(function(instance) {
      return instance.IsIdInArray(_fileHash1);
    }).then(function(result) {
      console.log(result);
      // App.basicInfoUpdate();
    }).catch(function(err) {
  ...
  submitTransaction: function() {
    var _fileHash = document.getElementById("fileDisplayArea").value;    

    Record.deployed().then(function(instance) {
      return instance.addRecord(_fileHash,{from:accounts[0], gas:500000});
    }).then(function(result) {
      console.log(result);
      // App.basicInfoUpdate();
    }).catch(function(err) {
